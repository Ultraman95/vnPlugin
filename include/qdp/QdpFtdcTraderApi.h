...
public:
	...
	///�û�������֤����Ӧ
	virtual void OnRspSendAuthCode(CQdpFtdcRspSendAuthCodeField *pRspSendAuthCode, CQdpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

	///�û���֤��Ӧ
	virtual void OnRspAuthByCode(CQdpFtdcRspAuthByCodeField *pRspAuthByCode, CQdpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
...
public:
	...
	///�û�������֤������
	virtual int ReqSendAuthCode(CQdpFtdcReqSendAuthCodeField *pReqSendAuthCode, int nRequestID) = 0;

	///�û���֤����
	virtual int ReqAuthByCode(CQdpFtdcReqAuthByCodeField *pReqAuthByCode, int nRequestID) = 0;
